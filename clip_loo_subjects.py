...
for subj_id in range(NUM_SUBJS):
    ...
    train_clip(clip_model, train_dataloaders, lr=1e-5, num_epochs=1, debug=True)
    ...
    torch.save(clip_model.state_dict(), "./saved_clip_model_minus_subj_" + str(subj_id) + "_words_" + str(NUM_WORDS))
